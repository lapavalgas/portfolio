...
export const useLoaderTmlStore = defineStore("loaderTml", {
  ...
  actions: {
    getAllCards(study_list: any, work_list: any, isPortuguese: Boolean) {
      let cardsList: any[] = [];
      let id = 0;
      ...
      for (const study of study_list) {
        ...
        let txtStartPreData = "Started the course of ";
        if (isPortuguese) {
          txtStartPreData = "Iniciou o curso de ";
        }
        ...
        let startCard = {
          ...
          localParteB: null,
          localParteC: null,
          txtStart: txtStartPreData + study.course_name,
          txtFullText: null,
          txtTopics: null,
          txtLinks: null,
          id: id,
      ...
      for (const work of work_list) {
        ...
        let txtStartPreData = "Started work on ";
        if (isPortuguese) {
          txtStartPreData = "Iniciou o trabalho na ";
        }
        ...
        let startCard = {
          ...
          localParteB: null,
          localParteC: null,
          txtStart: txtStartPreData + work.institution_name,
          txtFullText: null,
          txtTopics: null,
          txtLinks: null,
          id: id,
      ...
      for (const card of startCard) {
        ...
        let txtStartPreData = card.txtStart.replace("Started work on ", "Exited work on ");
        if (isPortuguese) {
          txtStartPreData = card.txtStart.replace("Iniciou o trabalho na ", "Encerrou o trabalho na ");
        }
